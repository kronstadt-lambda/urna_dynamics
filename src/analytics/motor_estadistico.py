...
class MotorMontecarloForense:
    ...
    def generar_combinaciones(self, lista_votantes: List[str], k: int) -> List[Tuple[str, ...]]:
        """
        Genera subconjuntos exactos de 'k' votantes. Usa combinatoria exacta si es viable,
        de lo contrario aplica un muestreo de Montecarlo.
        """
